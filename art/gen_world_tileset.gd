...
class_name GenWorldTileset

const ATLAS_PATH = "res://assets/generated/world_tiles.png"
const JSON_PATH = "res://assets/generated/world_tiles.json"
const OUTPUT_PATH = "res://assets/generated/world_tiles.tres"


func _run() -> void:
	print("Starting world tileset generation...")
	...
	var tile_size := json.tileSize as int
	...
	for sprite_name: String in json.sprites:
		...
		var atlas_coords := Vector2i(
			int((coords[0] as float) / float(tile_size)),
			int((coords[1] as float) / float(tile_size))
		)
	...
	print("Successfully generated world tileset at ", OUTPUT_PATH)
